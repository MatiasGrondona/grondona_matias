<div class="container-fluid" id="carrito">
    ...
    <table class="table table-hover table-dark table-responsive-md" border="0" cellpaddin="5px" cellspacing="1px">
        <?php
        if($cart == TRUE): ?>
            <div class="container">
                <div class="table-responsive-sm">
                    <table class="table table-bordered table-hover table-dark table-striped ml-3">
                        ...
                        <tr>
                            ...
                            <td>
                                <?php $path='<img src='.base_url('img/carrito.png').'with="25px" height="20px">'; 
                        ...
                        <tr>
                            ...
                            <td colspan="5" align="center">
                                ...
                                onclick="window.location='carrito-compra'">
